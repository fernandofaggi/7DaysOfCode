...
operador = prompt("INFORME A OPERACAO DESEJADA, + , - , * , / ");
if (operador !== "+")
{
...
var primeiroValor = prompt("Informe o Primeiro Valor");
var num1 = parseFloat(primeiroValor);

var segundoValor = prompt("Informe o Segundo Valor");
var num2 = parseFloat(segundoValor);


function calculo(operador, value1, value2) {
    if (operador === "+") {
...
alert ('O resultado é ' + calculo(operador, num1, num2)); 
}
